...
filename<-"Dr results of calcite from Sa.csv" 
...
flux.alpha.U.preRadon<-7793    # alpha flux of 1ppm U is 18468 alpha particles (cm-2*year)
flux.alpha.U.afterRadon<-10675
flux.alpha.Th<-5166           # alpha flux of 1ppm Th is 5166 alpha particles(cm-2*year)
