###
# This is the R script used for speleothem age iteration due to disequilibrium of 238U decay series.
...
### For sample LUM4347 from the paper, use the iteration method to get the age, modified from from Ikeya and Ohmura (1983).
...
gamma.attenuation<-0.5 # as the sample is not infinitely large considering the range of gamma ray.
