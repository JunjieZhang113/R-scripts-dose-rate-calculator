###
# This is the R script used for speleothem dose rate modelling due to disequilibrium of 238U decay series.
# reference: Zhang, J., Klose, J., Scholz, D., Marwan, N., Breitenbach, S.F.M., Katzschmann, L., Kraem-er, D., Tsukamoto, S., 2024. Isothermal thermoluminescence dating of speleothem growth - A case study from Bleﬂberg cave 2, Germany. Quaternary Geochronology 85, 101628. https://doi.org/10.1016/j.quageo.2024.101628 (open access)


### For sample LUM4347 from the paper

rm(list = ls())

setwd('D:/R scripts for dose rate calculation/R scripts and templates/R scripts for calcite and dolomite/R scripts for U disequilibrium') ## change the working directory as needed

output.file.name<-'LUM4347 dose rate simulation 3 segments.csv'  # define the output file name 
...
####################activity of U238. almost consistent with time################
a.U238<-12.44*U238 #   The activity of 1 ppm of U238 is 12.44 Bg/kg from Guerin2011
...
dataset <- data.frame('Time_ka'=time.sum,'alphaflux'=alphaflux.sum,'a_U238'=a.U238.sum,'a_U234'=a.U234.sum,'a_Th230'=a.Th230.sum,
...
legend("topright", legend=c("[238U]", "[234U]","[230Th]"),
...
legend("topright", legend=c("238U-234U", "234U-230Th","230Th-206Pb",'238U full chain'),
...
lines(x=1:422,y=rep(258,422),lty=2,col='blue')
lines(y=-20:258,x=rep(422,258+21),lty=2,col='blue')
