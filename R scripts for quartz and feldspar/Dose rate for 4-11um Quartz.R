##Dose rate calculation for fine quartz, 4-11 um.

##Input data into the csv file - Template 4-11um Quartz.csv
...
Dr<-read.csv("Template 4-11um Quartz.csv",header = TRUE)
#print(Dr) ###not necessary, just to make sure the 'read in' is successful

result_filename<-"Dr results quartz 4-11 um.csv"
