...
# reference: Zhang, J., Klose, J., Scholz, D., Marwan, N., Breitenbach, S.F.M., Katzschmann, L., Kraem-er, D., Tsukamoto, S., 2024. Isothermal thermoluminescence dating of speleothem growth - A case study from Ble?berg cave 2, Germany. Quaternary Geochronology 85, 101628. https://doi.org/10.1016/j.quageo.2024.101628 (open access)

### For sample LUM4347 from the paper

getwd()
#setwd('doserate_homogeneous_carbonate/correction_for_238U_disequilibrium') 

output.file.name<-'doserate_homogeneous_carbonate/correction_for_238U_disequilibrium/doserate_change_simulation_238U_disequilibrium.csv'  # define the output file name 
...
gamma.attenuation<-0.5 # Because the studied sample (BB2-1) is not infinitely large considering the range of gamma ray.
                       # It should be 1, when the sample is big enough.
