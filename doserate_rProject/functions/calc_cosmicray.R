...
calc_cosmicray <- function() {
  ...
  if (x < 1.7) {
    D0 <- 0.115 * exp(-x * 100 / 77.86) + 0.172
  } # fitted from data of Prescott and Hutton (1988), containing both soft and hard components
  else {
    D0 <- exp(-0.00055 * x) * 6072 / (((x + 11.6)^1.68 + 75) * (x + 212))
  } # Prescott and Hutton (1994), only  hard component is significant
