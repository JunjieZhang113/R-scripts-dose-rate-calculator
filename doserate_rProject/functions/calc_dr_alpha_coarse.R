...
calc_dr_alpha_coarse <- function() {
  ...
  a2k <- 0.83 # Correction factor to convert the k3.7 (a-value) to the keff, assuming equal Th and U activities (Zimmerman, 1971; Aitken 1985).
              # It is 0.86 for Th, and 0.80 for U.
