# function for alpha dose rate in an infinite homogeneous medium, for carbonates

calc_dr_alpha_infinite <- function() {
  
  # there is no a2k correction factor, as the keff (rather than a-value) is entered in the Template_carbonate_keff csv template
