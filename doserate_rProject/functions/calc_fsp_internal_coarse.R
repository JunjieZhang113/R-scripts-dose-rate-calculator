# function for internal dose rate, suitable for 20-1000 um
...
calc_fsp_internal_coarse <- function() {
  ...
  absorb.Rb <- beta_absorb[7] #absorb.Rb is fitted from Readhead(2002),unit µGy/a/(ppm Rb). It is only for internal dose, and it already includes the conversion factor
